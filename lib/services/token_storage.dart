...
///
/// Registered as a [GetxService] so it participates in GetX's dependency
/// injection lifecycle and can be accessed anywhere via [TokenStorage.to].
///
...
class TokenStorage extends GetxService {
  static TokenStorage get to => Get.find();
